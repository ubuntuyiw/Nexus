    ...
    operator fun invoke(chatRoomFilter: ChatRoomFilter): Flow<Resource<ChatRoomFilter>> = flow {
        ...
        try {
            val updatedData = chatRoomFilterRepository.updateChatRoomFilter {
                ...
                it.isSportsPolymath = BoolValue.of(chatRoomFilter.isSportsPolymath)
                it.isLiteratureTeacher = BoolValue.of(chatRoomFilter.isLiteratureTeacher)
                it.isPhilosophy = BoolValue.of(chatRoomFilter.isPhilosophy)
                it.isSportsPolymath = BoolValue.of(chatRoomFilter.isSportsPolymath)
